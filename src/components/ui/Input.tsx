...
export function Input({ label, error, required, className = '', ...props }: InputProps) {
  return (
    <div className="mb-4">
      ...
      <input
        className={`w-full px-3.5 py-2.5 border-[1.5px] rounded-lg text-[0.95rem] text-dark bg-[#252525] placeholder:text-gray-light transition-colors focus:outline-none focus:border-[#2dca72] focus:shadow-[0_0_0_3px_rgba(45,202,114,0.15)] ${
