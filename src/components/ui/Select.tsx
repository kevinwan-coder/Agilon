...
export function Select({ label, error, required, options, placeholder, className = '', ...props }: SelectProps) {
  return (
    <div className="mb-4">
      ...
      <select
        className={`w-full px-3.5 py-2.5 border-[1.5px] rounded-lg text-[0.95rem] text-dark bg-[#252525] transition-colors focus:outline-none focus:border-[#7ee8a8] focus:shadow-[0_0_0_3px_rgba(126,232,168,0.15)] ${
