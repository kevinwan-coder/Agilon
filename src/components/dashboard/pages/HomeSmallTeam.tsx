...
const RECENT_ACTIVITY = [
  { id: 1, icon: '📊', text: 'Invoice #1042 sent to Acme Corp', time: '2 min ago' },
  { id: 2, icon: '📅', text: 'Meeting scheduled with Jane Doe', time: '15 min ago' },
  { id: 3, icon: '🤖', text: 'Agilon Bot processed 3 expense receipts', time: '1 hour ago' },
  { id: 4, icon: '📋', text: 'Q1 Tax estimate updated', time: '2 hours ago' },
  { id: 5, icon: '🔒', text: 'NDA uploaded to VDR', time: '3 hours ago' },
  { id: 6, icon: '👥', text: 'Payroll processed for February', time: 'Yesterday' },
];
